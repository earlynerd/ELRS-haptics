...
The intended starting quantity is one main plus seven identical satellites per wrist. Both designs are four-layer, nominally 0.8 mm. All satellites use the same Gerbers and assembly configuration; the final satellite's JP1 is changed by cutting 1–2 and soldering 2–3.
