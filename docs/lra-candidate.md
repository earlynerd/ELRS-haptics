...
Revision 0.5 removes the central protector in favor of eight batteries with intact factory PCMs. See [current battery protection](pack-protection-implementation.md); the earlier ABLIC selection remains in the [sourcing history](protection-sourcing.md).
